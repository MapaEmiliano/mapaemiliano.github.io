...
let vtCount = 0, navCount = 0, eac3DCount = 0;

const checkIframe = (frame, bldng2D) => {
  ...
  if (frame === "vtFrame") {
    ...
    let defOpt = document.createElement("option"); // default option
    ...
    if(eac3DCount == 0){
      ...
      console.log("eac3DFrame already loaded")
      return;
    }
